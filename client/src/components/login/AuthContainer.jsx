...
function AuthContainer() {
  ...
  return (
    <div className="p-0  ">
      ...
      <div className="row">
        <div className="col-3"></div>
        <div className="col-6 bg-white text-info align-content-center border border-1 border-primary auth-cols">
          <p className="text-dark mt-3">
            Inicia sesión para poder  guardar tus notas y verlas cuando quieras. Si
      ...
      <div className="row">
        <div className="col-3"></div>
        <div className="col-6 bg-white text-info align-content-center border border-1 border-primary auth-cols rounded-bottom-3">
          <p className="text-dark mt-3">
          ...
          <div className="row">
            <div className="col-12">
              <button  onClick={() => renderComponent("RegisterForm")} className="w-100 p-2 btn btn-light  mb-2 border-secondary text-primary fw-bolder mt-3 mb-4">
                Registrarme
              </button>
            </div>
          </div>
