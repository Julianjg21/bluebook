          ...
          <div className="row bg-white">
            <form className="form-control pt-0" onSubmit={handleSubmit}>
              ...
              <div className="row">
                ...
                <div className="col-3"></div>
                <div className="col-7"><button className="border border-0 mt-1 text-primary bg-white" type="button" onClick={() => renderComponent("ResetPassword")}>¿Restablecer Contraseña?</button></div>
              </div>
              <div className="row">
                <div className="col-2"></div>
