          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <Navbar.Text className="text-warning fw-semibold me-3">
                <p>{userData.name}</p> {/* Displaying user name */}
              </Navbar.Text>
              <Nav.Link href="#login" className="text-light" onClick={handleLogOut}>
      ...
      <div className="row bg-white p-1 shadow">
        ...
        <div className="col-md-1 border border-grey col-12 rounded-2 mb-3 mb-md-0 h-columns">
          <div className="d-flex flex-md-column flex-row justify-content-around py-2 mt-md-5 mt-0">
            <button className="btn btn-secondary rounded-2 m-1 shadow" onClick={() => handleButtonClick('WatchTasksAndNotes')}>
              <FontAwesomeIcon icon={faHouse} />
            </button>
            <button className="btn btn-success rounded-2 m-1 shadow" onClick={() => handleButtonClick('AddNotes')}>
              <FontAwesomeIcon icon={faFileCirclePlus} />
            </button>
            <button className="btn btn-secondary rounded-2 m-1 shadow" onClick={() => handleButtonClick('WatchNotes')}>
              <FontAwesomeIcon icon={faBookBookmark} />
            </button>
            <button className="btn btn-secondary rounded-2 m-1 shadow" onClick={() => handleButtonClick('AddTasks')}>
